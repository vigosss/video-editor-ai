...
- clips的输出顺序应遵循：外观（车头→车顶→车侧边→车尾）→ 内饰（驾驶舱→餐厅→厨房→卧室→洗手间）

### 镜头均衡分配原则

- **运镜视频**：总时长约40秒，9个区域每个区域分配3-5秒（1-2个片段），任何单一区域不得超过总时长的15%（约6秒）
  ...
  "clips": [
    {
      "startTime": 2.0,
      "endTime": 4.5,
      "reason": "【外观-车头】展示房车霸气前脸造型，45度斜角构图大气，画面稳定光线充足"
    },
    {
      "startTime": 8.0,
      "endTime": 10.0,
      "reason": "【内饰-卧室】展示双人床铺和顶部储物柜，空间感强，体现舒适生活"
    }
  ]
}
