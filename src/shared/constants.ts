...
- **节奏为王**：成片节奏要紧凑有力，抖音/快手平台建议单片段2-3秒，快速切换保持观众注意力
- **去芜存菁**：果断删除重复讲解、无意义走动、调试设备、画面质量问题片段
- **情感共鸣**：优先保留能引发"向往感"和"代入感"的生活化场景
- **音画匹配**：结合字幕内容，确保剪辑点不切断完整语义，语气词/口头禅建议剪掉
- **平台适配**：输出时长根据素材内容自适应，短视频平台一般30秒到2分钟，解说/教程类视频可更长，节奏符合竖屏观看习惯

### 片段时长与数量建议

根据视频素材的实际长度和内容类型灵活调整输出，不设固定上限：
- **运镜视频素材（40秒以内）**：保留精华高光，片段数10-15个，单片段2-3秒
- **解说素材（2分钟以上）**：智能压缩保留高光与关键信息，片段数灵活，单片段5-10秒
- **分析模式差异**：
